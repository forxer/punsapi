...
This class allows to handle data entered in arrays. Very usefull for query results.

@param	array	arry_data		Array containing the data
@param	integer	int_index		Cursor position
@param	integer	int_row_count	Nomber of row
@param	integer	int_col_count	Number of column
@param	integer	fetch_index		Index of position, used locally
*/
